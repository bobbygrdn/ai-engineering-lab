...
from schema import load_memories, prioritize_memories, assemble_prompt, parse_and_writeback, MessageBuffer, validate_tool_input, invoke_tool, extract_tool_call
from logger import logger
from auth import authenticate_user, register_user
from db import create_memories_table, create_users_table, create_messages_table, update_email, update_password, update_username, is_ambiguous_message
import os
import json
import getpass
import sys
        ...
        while True:
            ...
            if tool_name and tool_args:
                try:
                    ...
                    print(f"'{tool_name}' was successfully executed.")
